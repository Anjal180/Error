...
var html = '<tr>';
    ...
    html += '<td><input type="file" name="doc[]" id="inputfile[]" data-id='+index+' class="form-control inputfile"/></td>';
    html += ' <td><input type="text" class="outputfile" id="outputfile'+index+'" name="filename[]"><input id="extension'+index+'" type="text" name="extension" disabled></td>';
